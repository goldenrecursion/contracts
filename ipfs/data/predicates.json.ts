...
const json: readonly IPFSPredicateBody[] = [
  ...
  },
  {
    ...
    constraints: [
      {
        type: "format",
        regex_pattern: "^https?:\\/\\/(?:www\\.|vm\\.|vt\\.|m\\.)?(?:tiktok.com)\\/([\\w\\-_.!~*'()%:@&=+$,\\/?;#]+)$"
      }
    ],
    description: "The primary, official TikTok profile URL associated with this entity. TikTok profile URLs tend to take the form of https://www.tiktok.com/[username]. The TikTok URL should not point to a TikTok video post.",
    object_type: "anyURI",
    citation_requirement: CitationRequirement.Optional
  },
  {
    ...
    description: "The primary, official source code URL associated with this entity. The primary and official source code URL should not be a fork off of a more primary and official version. Source code URLs may often be Github URLs, but do not always have to be. The source code URL should point to the source code specifically associated with the entity, not a product of the entity, a parent organization of the entity, etc.",
    object_type: "anyURI",
    citation_requirement: CitationRequirement.Optional
  },
  {
  ...
  },
  {
    ...
    description: "The primary and official Medium profile URL associated with this entity.",
    object_type: "anyURI",
    citation_requirement: CitationRequirement.Optional
  },
  {
    ...
    constraints: [
      {
        type: "format",
        regex_pattern: "^https?:\\/\\/(?:www\\.)?(?:angel.co)\\/((?:company|u|v|p)?\\/?(?:[\\w\\-_.!~*'()%:@&=+$,\\/?;#]+))$"
      }
    ],
    description: "The primary and official Angellist profile URL associated with this entity. The URL should ideally point towards the company's overview page (i.e. https://angel.co/company/<company_name>) and not another view (such as https://angel.co/company/<company_name>/jobs).",
    object_type: "anyURI",
    citation_requirement: CitationRequirement.Optional
  },
  {
    ...
    constraints: [
      {
        type: "format",
        regex_pattern: "^https?:\\/\\/(?:apps.apple.com)\\/((?:[-a-zA-Z0-9@:%._\\+~#=]{2,20}\\/)?(?:app|developer)\\/(?:[\\w\\-_.!~*'()%:@&=+$,\\/?;#]+))$"
      }
    ],
    description: "The primary and official URL for this product on Apple's app store. Apps that are not officially owned and associated with the entity should not be used.",
    object_type: "anyURI",
    citation_requirement: CitationRequirement.Optional
  },
  {
    ...
    description: "The primary and official Instagram URL for this entity. Instagram profiles that are not officially owned by and associated with the entity should not be used.",
    object_type: "anyURI",
    citation_requirement: CitationRequirement.Optional
  },
  {
    ...
    constraints: [
      {
        type: "format",
        regex_pattern: "^https?:\\/\\/(?:[0-9a-z_!~*'()-]{1,63}\\.)?(?:twitter\\.com)\\/(?:#!\\/)?@?([^/?#]*)(?:[?#].*)?\\/?$"
      }
    ],
    description: "The primary and official Twitter profile URL associated with this entity.",
    object_type: "anyURI",
    citation_requirement: CitationRequirement.Optional
  },
  {
    ...
    constraints: [
      {
        type: "format",
        regex_pattern: "^https?:\\/\\/(?:[0-9a-z_!~*'()-]{1,63}\\.)?(?:(?:web|m)\\.)?(?:(?:facebook|fb)\\.com)\\/((?:pg|pages|pages\\/category|groups|profile.php\\?id=)?\\/?(?:[\\w\\-\\.\\+]+)\\/?(?:[\\w\\-\\.\\+]+)?\\/?)$"
      }
    ],
    description: "The primary and official Facebook profile URL associated with this entity. A facebook profile URL for an associated entity (such as a fan club, a parent organization, or a subsidiary) should not be used.",
    object_type: "anyURI",
    citation_requirement: CitationRequirement.Optional
  },
  {
    ...
    description: "The primary and official Pinterest profile URL associated with this entity. A link to a Pinterest collection or specific post should not be used.",
    object_type: "anyURI",
    citation_requirement: CitationRequirement.Optional
  },
  {
    ...
    constraints: [
      {
        type: "format",
        regex_pattern: "^https?:\\/\\/(?:www\\.)?(?:play.google.com)\\/(?:store)\\/([\\w\\-_.!~*'()%:@&=+$,\\/?;#]+)$"
      }
    ],
    description: "The primary and official Google Play store URL associated with this entity. Apps that are not officially owned by and associated with the entity should not be used.",
    object_type: "anyURI",
    citation_requirement: CitationRequirement.Optional
  },
  {
    ...
    description: "URL of an organization's, product's, or cryptocurrency’s official community forum. Unofficial community forum's (such as those that the organization, product, or cryptocurrency has never officially affiliated themselves with) should not be used.",
    object_type: "anyURI",
    citation_requirement: CitationRequirement.Optional
  },
  {
    ...
    constraints: [
      {
        type: "format",
        regex_pattern: "^https?:\\/\\/(?:www\\.)?(?:github\\.com)\\/((?:[\\w\\.@\\:\\-~]+\\/?){1,2})$"
      }
    ],
    description: "The primary and official Github profile URL associated with this entity. Links to repositories (rather than profiles) should not be used.",
    object_type: "anyURI",
    citation_requirement: CitationRequirement.Optional
  },
  {
    ...
    description: "The primary and official URL associated with a person’s PhD dissertation. Either a URL where the doctoral thesis can be directly downloaded or that contains the doctoral thesis contents itself may be used",
    object_type: "anyURI",
    citation_requirement: CitationRequirement.Optional
  },
  {
    ...
    constraints: [
      {
        type: "format",
        regex_pattern: "^https?:\\/\\/(?:www\\.)?(?:(?:crunchbase)\\.com)\\/((?:person|organization|event|acquisition|funding_round|fund)\\/(?:[\\w\\-_.!~*'()%:@&=+$,\\/?;#]+))$"
      }
    ],
    description: "The primary and official URL associated with this entity's Crunchbase profile page. Only the Crunchbase profile directly affiliated with the entity should be used, not the Crunchbase profile for the entity's parent organization, subsidiaries, etc.",
    object_type: "anyURI",
    citation_requirement: CitationRequirement.Optional
  },
  {
    ...
    constraints: [
      {
        type: "format",
        regex_pattern: "^https?:\\/\\/(?:www\\.)?(?:telegram|t)\\.me\\/([a-zA-Z0-9_-]+)\\/?$"
      }
    ],
    description: "The primary and official Telegram channel associated with this entity. Support channels, fan channels, or other channels not officially associated with the entity should not be used.",
    object_type: "anyURI",
    citation_requirement: CitationRequirement.Optional
  },
  {
    ...
    constraints: [
      {
        type: "format",
        regex_pattern: "^https?:\\/\\/(?:www\\.)?(?:pitchbook.com)\\/profiles\\/?((?:investor|company|advisor|fund|limited-partner)\\/(?:[\\w\\-_.!~*'()%:@&=+$,\\/?;#]+))$"
      }
    ],
    description: "The primary and official Pitchbook URL associated with this entity. The primary and official Pitchbook URL should be directly associated with this entity and not a Pitchbook URL for the entity's parent/subsidiary organization.",
    object_type: "anyURI",
    citation_requirement: CitationRequirement.Optional
  },
  {
    ...
    description: "The primary and official Whitepaper URL associated with this cryptocurrency. Litepapers are allowed as whitepapers.",
    object_type: "anyURI",
    citation_requirement: CitationRequirement.Optional
  },
  {
    ...
    constraints: [
      {
        type: "format",
        regex_pattern: "^https?:\\/\\/(?:www\\.)?(?:reddit\\.com|redd.it)\\/(?:(?:user|(?:r)|(?:u))\\/)?([\\w\\.\\-\\+]+)\\/?$"
      }
    ],
    description: "The primary and official Reddit profile or subreddit URL associated with this entity. A Reddit profile or subreddit URL associated with the entity should have an evidenced source of official affiliation - i.e. a reference to the Reddit on the entity's website.",
    object_type: "anyURI",
    citation_requirement: CitationRequirement.Optional
  },
  {
    ...
    description: "The primary and official Youtube profile URL associated with this entity. Links to specific youtube videos should not be used.",
    object_type: "anyURI",
    citation_requirement: CitationRequirement.Optional
  },
  {
    ...
    constraints: [
      {
        type: "format",
        regex_pattern: "^https?:\\/\\/(?:[0-9a-z_!~*'()-]{1,63}\\.)?(?:(?:linkedin)\\.com)\\/((?:in|company|school)\\/(?:[\\w\\-_.!~*'()%:@&=+$,\\/?;#]+))$"
      }
    ],
    description: "The primary and official LinkedIn profile URL associated with this entity. For example,  is the primary and official LinkedIn profile URL for Bill Gates.",
    object_type: "anyURI",
    citation_requirement: CitationRequirement.Optional
  },
  {
    ...
    constraints: [
      {
        type: "format",
        regex_pattern: "^https?:\\/\\/(?:www\\.)?(?:coinmarketcap.com)\\/((?:currencies|exchanges)\\/(?:[\\w\\-_.!~*'()%:@&=+$,\\/?;#]+))$"
      }
    ],
    description: "The primary and official Coinmarketcap URL associated with this cryptocurrency. Coinmarketcap URLs tend to be structured as https://coinmarketcap.com/currencies/<currency name> for currencies and https://coinmarketcap.com/exchanges/<exchange name> for exchanges. An entity's Coinmarketcap URL should not point to a currency that is forked off of or otherwise not officially associated with the entity.",
    object_type: "anyURI",
    citation_requirement: CitationRequirement.Optional
  },
  {
  ...
  },
  {
    ...
    description: "The CEO of an organization is the individual charged with the management of the organization – especially an independent legal entity such as a company or nonprofit institution. The CEO of an organization typically reports to the board of directors.",
    object_type: "entity",
    citation_requirement: CitationRequirement.Recommended
  },
  {
    ...
    description: "An organization that this person was directly involved with the initial inception of, often marked by the person’s intention to start the organization or the purchasing of operating assets for the organization.",
    object_type: "entity",
    citation_requirement: CitationRequirement.Recommended
  },
  {
  ...
  },
  {
    ...
    name: "Website",
    label: "URL of the primary and official website associated with this entity",
    multiplier: 3,
    constraints: [
      {
        type: "format",
      ...
      },
      {
        type: "format",
        allow: false,
        regex_pattern: "^https?:\\/\\/(?:apps.apple.com)\\/((?:[-a-zA-Z0-9@:%._\\+~#=]{2,20}\\/)?app\\/(?:[\\w\\-_.!~*'()%:@&=+$,\\/?;#]+))$"
      },
      {
        type: "format",
        allow: false,
    ...
    description: "The primary and official website URL associated with this entity. The 'website' predicate should be reserved for URL's that represent a website directly associated with the entity. Social links that may be used as values in other predicates should not be used.",
    object_type: "anyURI",
    citation_requirement: CitationRequirement.Optional
  },
  {
    ...
    description: "The phone number associated with this entity that is 1. public (it is openly known the entity is associated with this phone number) and 2. official (the entity has formally associated themselves with this phone number by posting it on a website, social media link, etc. that they are in control of).",
    object_type: "string",
    citation_requirement: CitationRequirement.Recommended
  },
  {
    ...
    description: "The date that a company legally starts operating, as indicated by the intentions of the company’s founder(s) to start a particular business and usually the purchase or production of operating assets. The founding date would be the earliest of any of these two events in the company’s lifetime.",
    object_type: "date",
    citation_requirement: CitationRequirement.Recommended
  },
  {
    ...
    description: "The official date of birth of a person, as evidenced by a resource officially owned by, operated by, or directly affiliated with the person stating their birth date. Official documentation, such as a birth certificate, may also provide evidence.",
    object_type: "date",
    citation_requirement: CitationRequirement.Recommended
  },
  {
    ...
    description: "The date that the incorporation requirements for a company were legally filed in its initial country or state of incorporation. Each state sets its own incorporation requirements, but the date of incorporation is typically the filed date of the corporate charter.",
    object_type: "date",
    citation_requirement: CitationRequirement.Recommended
  },
  {
  ...
  },
  {
    ...
    description: "The unique Wikidata ID (item, property, or lexem) associated with this entity on Wikidata. A Wikidata ID is a number prefixed by a letter. Items, also known as Q-items, are prefixed with ‘Q’. Properties are prefixed by ‘P’. Lexemes are prefixed by ‘L’.",
    object_type: "string",
    citation_requirement: CitationRequirement.Optional
  },
  {
    ...
    description: "The primary and official Discord URL for this entity. Discord URLs not officially affiliated with the entity should not be used.",
    object_type: "anyURI",
    citation_requirement: CitationRequirement.Optional
  },
  {
    ...
    description: "The top-level URL of the official blog associated with this entity. A blog is a regularly updated website or web page, typically written in informal diary-style posts and displayed in reverse chronological order.",
    object_type: "anyURI",
    citation_requirement: CitationRequirement.Optional
  },
  {
    ...
    description: "The unique CIK (Central Index Key) number associated with this entity. The CIK number is used as a unique identifier for financial filings with the U.S. Security and Exchange Commission (SEC), and is assigned by the SEC.",
    object_type: "string",
    citation_requirement: CitationRequirement.Optional
  },
  {
    ...
    description: "The unique Glassdoor ID associated with this entity on Glassdoor. Glassdoor ID pages provide a profile of a company along with reviews of the company by current and former employees, reports on interviews with the company, and other data on the company.",
    object_type: "string",
    citation_requirement: CitationRequirement.Optional
  },
  {
    ...
    description: "The unique Google Scholar Author ID associated with this person on Google Scholar.",
    object_type: "string",
    citation_requirement: CitationRequirement.Optional
  },
  {
    ...
    name: "CAGE Code",
    label: "Code assigned to a company or organization by the Defense Logistics Agency.",
    constraints: [
      {
        type: "format",
    ...
    description: "Five-character alpha-numeric, unique identifier assigned and managed by the Defense Logistics Agency (DLA), which provide a standardized method of identifying a given facility at a specific location.",
    object_type: "string",
    citation_requirement: CitationRequirement.Optional
  },
  {
    ...
    label: "Unique Entity Identifier (UEI) assigned to a company or organization by the US General Services Administration.",
    constraints: [
      {
        type: "format",
    ...
    description: "A twelve character alphanumeric Unique Entity Identifier (UEI) assigned to a company or organization by the US General Services Administration (GSA).",
    object_type: "string",
    citation_requirement: CitationRequirement.Recommended
  },
  {
    ...
    name: "DUNS Number",
    label: "Nine-digit identifier issued by Dun & Bradstreet that uniquely identifies an organization.",
    constraints: [
      {
        type: "format",
        regex_pattern: "^[0-9]{9}$"
    ...
    description: "Nine-digit identifier issued by Dun & Bradstreet that uniquely identifies an organization. ",
    object_type: "string",
    citation_requirement: CitationRequirement.Recommended
  },
  {
    ...
    label: "One or more individual accelerator batches organized by a parent accelerator.",
    ...
    description: "One or more individual accelerator batches organized by a parent accelerator.",
    object_type: "entity",
    citation_requirement: CitationRequirement.Recommended
  },
  {
    ...
    label: "The organization that organizes and runs an individual accelerator batch.",
    ...
    description: "The organization that organizes and runs an individual accelerator batch. While each accelerator batch may or may not have its own organization or legal entity, the parent accelerator is the organization that organizes each accelerator batch.",
    object_type: "entity",
    citation_requirement: CitationRequirement.Recommended
  },
  {
  ...
  },
  {
    ...
    label: "An accelerator batch is a group of companies that are funded and mentored as a batch.",
    ...
    description: "An accelerator batch is a group of companies that are funded and mentored as a batch.",
    object_type: "entity",
    citation_requirement: CitationRequirement.Recommended
  },
  {
  ...
  },
  {
    ...
    description: "The IMDb ID that is used for this entity. An entity can be a person (for example an actor).",
    object_type: "string",
    citation_requirement: CitationRequirement.Optional
  },
  {
    ...
    description: "The IMDb ID that is used for this entity. An entity can be creative work (Movie, TV show, etc.)",
    object_type: "string",
    citation_requirement: CitationRequirement.Optional
  },
  {
    ...
    description: "Accelerators are cohort-based organizations for startups and early stage companies, providing education, mentorship, and seed funding.",
    object_type: "entity",
    citation_requirement: CitationRequirement.Recommended
  },
  {
    ...
    description: "URL for a company or organization's profile page in the Y Combinator directory",
    object_type: "anyURI",
    citation_requirement: CitationRequirement.Optional
  },
  {
    ...
    name: "Invested in",
    label: "Companies, Organizations, or Cryptocurrencies that the entity has invested in.",
    constraints: [
      {
        type: "predicate_object",
        rules: [
    ...
    description: "Companies, Organizations, or Cryptocurrencies that the entity has invested in.",
    object_type: "entity",
    citation_requirement: CitationRequirement.Recommended
  },
  {
    ...
    description: "Investors are the companies, organizations, and people that have invested in an entity. ",
    object_type: "entity",
    citation_requirement: CitationRequirement.Recommended
  },
  {
    ...
    name: "Exchange",
    label: "Real or virtual facility where brokers and traders can buy and sell securities",
    constraints: [
      {
        type: "predicate_object",
        rules: [
    ...
    description: "Real or virtual facility where brokers and traders can buy and sell securities, including stock, equities, securities, and bonds. Cryptocurrency exchanges should not be included as valid for this predicate.",
    object_type: "entity",
    citation_requirement: CitationRequirement.Recommended
  },
  {
    ...
    label: "Reference number or ID for the company in the place of incorporation",
    constraints: [
      {
        type: "predicate_object",
        rules: [
    ...
    description: "Reference number or ID for a company in the place of incorporation, as assigned by the incorporating agency.",
    object_type: "string",
    citation_requirement: CitationRequirement.Recommended
  },
  {
  ...
  },
  {
    ...
    description: "The fax number associated with this entity that is 1. public (it is openly known the entity is associated with this fax number) and 2. official (the entity has formally associated themselves with this fax number by posting it on a website, social media link, etc. that they are in control of).",
    object_type: "string",
    citation_requirement: CitationRequirement.Recommended
  },
  {
    ...
    description: "Legal or brand name previously associated with an entity, such as a company, organization, or product.",
    object_type: "string",
    citation_requirement: CitationRequirement.Recommended
  },
  {
    ...
    description: "URL of this cryptocurrency's profile for a blockchain explorer platform, which allows exploration of activity on a given blockchain.",
    object_type: "anyURI",
    citation_requirement: CitationRequirement.Optional
  },
  {
    ...
    name: "Maximum Supply",
    label: "Maximum number of cryptocurrency coins/tokens that can be created and released.",
    constraints: [
      {
        type: "predicate_object",
        rules: [
    ...
    description: "Maximum number of cryptocurrency coins/tokens that can ever be released. Once the maximum supply cap is reached, no additional coins or tokens will be mined, minted, or produced.",
    object_type: "integer",
    citation_requirement: CitationRequirement.Recommended
  },
  {
    ...
    description: "Date the first block of a cryptocurrency was created, also referred to as Block 0.",
    object_type: "date",
    citation_requirement: CitationRequirement.Recommended
  },
  {
    ...
    label: "Amount of funding (USD) that was awarded for a government award or contract.",
    description: "Amount of funding (USD) that was awarded for a government award or contract.",
    object_type: "float",
    citation_requirement: CitationRequirement.Recommended
  },
  {
    ...
    description: "Government agency associated with this entity, such as the agency awarding a grant or funding award.",
    object_type: "entity",
    citation_requirement: CitationRequirement.Recommended
  },
  {
    ...
    description: "The five-digit classification number associated with the United Kingdom Standard Industrial Classification (SIC) of Activities. ",
    object_type: "string",
    citation_requirement: CitationRequirement.Recommended
  },
  {
    ...
    description: "The four-digit classification number associated with the U.S. Standard Industrial Classification (SIC) system.",
    object_type: "integer",
    citation_requirement: CitationRequirement.Recommended
  },
  {
    ...
    description: "The unique identifier for the U.S. Environmental Protection Agency (EPA) Distributed Structure-Searchable Toxicity (DSSTox) database.",
    object_type: "string",
    citation_requirement: CitationRequirement.Recommended
  },
  {
    ...
    description: "Classification code associated with the North American Industry Classification System (NAICS).",
    object_type: "integer",
    citation_requirement: CitationRequirement.Recommended
  },
  {
    ...
    description: "The alphanumeric identifier assigned to objects in space in the COSPAR system, administered by the UN Committee on Space Research.",
    object_type: "string",
    citation_requirement: CitationRequirement.Recommended
  },
  {
    ...
    description: "The generic or nonproprietary name assigned to a pharmaceutical substance by the World Health Organization (WHO) International Nonproprietary Name (INN) system.",
    object_type: "string",
    citation_requirement: CitationRequirement.Recommended
  },
  {
    ...
    description: "Seven digit identifier indicating the ontology of the gene in the Gene Ontology (GO) intitiative.",
    object_type: "string",
    citation_requirement: CitationRequirement.Recommended
  },
  {
    ...
    name: "ISBN",
    label: "International Standard Book Number (ISBN) for a book (first edition of hardcover print by default)",
    constraints: [
      {
        type: "unique_object"
      }
    ],
    description: "International Standard Book Number (ISBN) for a book (first edition of hardcover print by default). The ISBM is 10 digits long if assigned before 2007, and 13 digits long if assigned on or after 1 January 2007.",
    object_type: "string",
    citation_requirement: CitationRequirement.Recommended
  },
  {
    ...
    name: "NCBI Locus ID",
    label: "Reference sequences and stable database identifier associated with a gene.",
    constraints: [
      {
        type: "unique_object"
      }
    ],
    description: "The alphanumeric reference sequences and stable database identifier associated with a gene by the National center for Biotechnology Information (NCBI) of the National Library of Medicine.",
    object_type: "string",
    citation_requirement: CitationRequirement.Recommended
  },
  {
    ...
    description: "The parent company that owns or controls another company.  Holding or shell companies which do not have business operations and are set up specifically to passively own should not be included as valid for this predicate.\n",
    object_type: "entity",
    citation_requirement: CitationRequirement.Recommended
  },
  {
    ...
    description: "The subsidiary company that is owned or controlled by the parent company, meaning the parent company has or controls more than half of its stock.",
    object_type: "entity",
    citation_requirement: CitationRequirement.Recommended
  },
  {
  ...
  },
  {
    ...
    description: "Parent of a person, including birth parent and parent through legal adoption.",
    object_type: "entity",
    citation_requirement: CitationRequirement.Recommended
  },
  {
  ...
  },
  {
    ...
    label: "People who are current members of the Board of Directors of a company",
    constraints: [
      {
        type: "predicate_object",
        rules: [
    ...
    description: "People who are current members of the Board of Directors of a company.",
    object_type: "entity",
    citation_requirement: CitationRequirement.Recommended
  },
  {
    ...
    description: "Entity a person is a current member of the Board of Directors of.",
    object_type: "entity",
    citation_requirement: CitationRequirement.Recommended
  },
  {
  ...
  },
  {
    ...
    label: "Employer Identification Number (EIN) assigned by the US Internal Revenue Service.",
    constraints: [
      {
        type: "format",
        regex_pattern: "^[0-9]{9}$"
    ...
    description: "The IRS Employer Identification Number is the 9-digit Employer Identification Number (EIN) assigned by the US Internal Revenue Service (IRS).",
    object_type: "string",
    citation_requirement: CitationRequirement.Recommended
  },
  {
    ...
    description: "Geographical location of an entity. Location refers to an established geographical area or region, as well as the area relative to where something else is located.",
    object_type: "entity",
    citation_requirement: CitationRequirement.Recommended
  },
  {
  ...
  },
  {
    ...
    description: "The Patent Application Number is the identification number for a patent application assigned to a patent by the United States Patent and Trademark Office. The patent application number should have commas, slashes, and other punctuation removed. Ie. 13/791,909 → Patent Application Number → 13791909",
    object_type: "string",
    citation_requirement: CitationRequirement.Recommended
  },
  {
  ...
  },
  {
    ...
    description: "Date that an event or other entity starts, per a source owned or controlled by the entity such as an official blog or a press release.",
    object_type: "date",
    citation_requirement: CitationRequirement.Recommended
  },
  {
    ...
    description: "Acquisitions made by the company, per a source owned or controlled by the entity such as an official blog or a press release.",
    object_type: "entity",
    citation_requirement: CitationRequirement.Recommended
  },
  {
    ...
    description: "Status of a bill in the legislative process: enacted, rejected, pending, appealed.",
    object_type: "string",
    citation_requirement: CitationRequirement.Recommended
  },
  {
  ...
  },
  {
    ...
    label: "The webpage attributed to a particular restaurant in the Michelin Guide.",
    constraints: [
      {
        type: "predicate_object",
        rules: [
      ...
      {
        type: "format",
        regex_pattern: "^https:\\/\\/guide\\.michelin\\.com\\/\\w{2}(?:\\/\\w{2})?\\/([^\\s]+)"
      }
    ],
    description: "The webpage attributed to a particular restaurant in the Michelin Guide.",
    object_type: "anyURI",
    citation_requirement: CitationRequirement.Optional
  }
] as const;
