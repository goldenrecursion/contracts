...
export interface GoldenAirdropV1Interface extends utils.Interface {
  functions: {
...
export interface GoldenAirdropV1 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GoldenAirdropV1Interface;
  ...
  filters: {
    ...
    Withdrawn(withdrawnBy?: string | null, amount?: null): WithdrawnEventFilter;
  };
