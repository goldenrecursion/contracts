...
export interface GoldenSchemaGovernorInterface extends utils.Interface {
  functions: {
...
export interface GoldenSchemaGovernor extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GoldenSchemaGovernorInterface;
